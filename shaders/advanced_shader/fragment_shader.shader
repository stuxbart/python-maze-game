...
in vec4 v2f_positionW;  // Position in word space
in vec4 v2f_normalW;  // Surface normal in word space
...
void main() {
    ...
    out_color = ( Emissive + Ambient + Diffuse + Specular ) * texture( u_Textures[index], v2f_texcoord );
}
